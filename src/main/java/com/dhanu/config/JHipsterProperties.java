...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "dhanu@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "dhanu API";

        private String description = "dhanu API documentation";
